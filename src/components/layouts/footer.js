    ...
    return (
        <div>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-12 col-sm-7 mb-3 order-1 order-md-2">
                        ...
                        <p className="footer-text">Neighborhood aid helps to facilitate exchanged acts of kindness by connecting<br/> people in need to willing volunteers in your (or any) community.</p>
